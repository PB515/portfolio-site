...
## Current status
Phase 0 of 5 (in progress) · last completed: scaffolded Next.js + TS + Tailwind (app router, no src dir); 03b APPROVED + frozen · next up: design tokens → globals.css; empty routes (03b); npm install; git identity + SSH alias + Supabase (Mumbai) · last commit: (none yet) · tooling: Node 26.2 / npm 11.13 / git 2.54.
NOTE: Next.js here is a NEW/BREAKING version — read `node_modules/next/dist/docs/` before writing route code.
